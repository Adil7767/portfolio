      ...
      >
        ...
        >
          <div className="sm:text-center lg:text-left">
            ...
            <p
              className={`mt-3 sm:mt-5 text-base sm:text-lg md:text-xl sm:max-w-xl sm:mx-auto md:mt-5 lg:mx-0 ${darkMode ? "text-black" : "text-white"
                }`}
            >
              I am a <strong>Front-End / Full-Stack Developer</strong> currently working as a 
              <strong> Front-End Developer</strong> at <strong>Next.js</strong>.
            </p>
